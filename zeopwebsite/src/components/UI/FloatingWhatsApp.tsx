...
const FloatingWhatsApp: React.FC = () => {
  ...
  const isTourDetailPage = location.pathname.startsWith('/tours/') && location.pathname !== '/tours';
  ...
  return (
    <motion.button
      ...
      className="bg-green-500 hover:bg-green-600 text-white p-4 shadow-xl flex items-center justify-center cursor-pointer overflow-hidden"
