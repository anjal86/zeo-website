                      ...
                      >
                        ...
                        <div className="flex-1 p-6 border-r border-gray-50">
                          ...
                          <div className="space-y-3">
                            ...
                            <Link to="/tours" className="block text-sm text-primary font-bold pt-2 border-t border-gray-50 mt-2">
                              All Nepal Tours →
                            </Link>
                          </div>
                        </div>
                        ...
                        <div className="flex-1 p-6 border-r border-gray-50">
                          ...
                          <div className="space-y-3">
                            ...
                            <Link to="/destinations" className="block text-sm text-secondary-dark font-bold pt-2 border-t border-gray-50 mt-2">
                              All Destinations →
                            </Link>
                          </div>
                        </div>
                        ...
                        <div className="flex-1 bg-gray-50/50 p-6">
                          ...
                          <div className="space-y-4">
                            <Link to="/everest-base-camp-guide" className="group block border-b border-gray-100 pb-3 last:border-0">
                            ...
                            <Link to="/nepal-visa-guide" className="group block border-b border-gray-100 pb-3 last:border-0">
                            ...
                            <Link to="/best-time-to-visit-nepal" className="group block border-b border-gray-100 pb-3 last:border-0">
                            ...
                            <Link to="/kailash-mansarovar-yatra-guide" className="group block border-b border-gray-100 pb-3 last:border-0">
                      ...
                      >
                        ...
                        <div className="w-3/5 p-6 border-r border-gray-50">
                          ...
                          <div className="space-y-3">
                            ...
                            <Link to="/kailash-mansarovar" className="block text-[10px] font-bold text-primary uppercase tracking-tighter mt-2">
                              View All Packages →
                            </Link>
                          </div>
                        </div>
                        ...
                        <div className="w-2/5 bg-gray-50/50 p-6 overflow-y-auto max-h-[450px]">
                          ...
                          <div className="space-y-4">
                            <Link to="/kailash-yatra-nri-guide" className="group block border-b border-gray-100 pb-3 last:border-0">
                            ...
                            <Link to="/kailash-packing-list" className="group block border-b border-gray-100 pb-3 last:border-0">
                            ...
                            <Link to="/kailash-fitness-medical-guide" className="group block border-b border-gray-100 pb-3 last:border-0">
                            ...
                            <Link to="/kailash-inner-kora-guide" className="group block border-b border-gray-100 pb-3 last:border-0">
                            ...
                            <Link to="/kailash-mansarovar-yatra-guide" className="group block pt-2">
                    ...
                    {navItems.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {hasDropdown ? <span>{item.label}</span> : <Link to={item.href} className="flex-1">{item.label}</Link>}
                                ...
                                {item.label === 'Kailash Mansarovar' && (
                                  <div className="p-4 space-y-4">
                                    ...
                                    <div className="pt-2 space-y-3 border-t border-gray-100">
                                      ...
                                      <Link
                                        to="/kailash-fitness-medical-guide"
                                        onClick={handleNavClick}
                                        className="flex items-center gap-2 py-1 text-sm text-gray-700 font-bold"
                                      >
                                      ...
                                      <Link
                                        to="/kailash-mansarovar-yatra-guide"
                                        onClick={handleNavClick}
