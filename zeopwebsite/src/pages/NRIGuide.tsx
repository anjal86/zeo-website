...
const NRIGuide: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Kailash Mansarovar Yatra for NRIs | Permits & Global Booking Guide 2026"
        description="The ultimate guide for NRIs from USA, UK, Canada & UAE. Expert advice on Tibet permits for foreign citizens, international payments, and specialized NRI Yatra packages."
        keywords="NRI Kailash Yatra, foreign passport Kailash permit, Kailash Yatra from USA, US citizen Tibet visa, Kailash Yatra cost for NRIs, Mount Kailash pilgrimage NRI"
        url={pageUrl}
        image="https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=2070"
        type="article"
      ...
      <div className="bg-white">
        ...
        <div className="container mx-auto px-4 max-w-4xl py-16 space-y-20">
          ...
          <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            ...
            <p className="text-gray-600 mb-8">Before you depart, ensure you have reviewed our <Link to="/kailash-packing-list" className="text-primary font-bold hover:underline">Complete Kailash Packing List</Link> and gear guide.</p>
