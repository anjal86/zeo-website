...
const KailashGuide: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Kailash Mansarovar Yatra Guide 2026 | Indian Pilgrims & NRIs — Zeo Tourism"
        description="Complete Kailash Mansarovar Yatra guide for Indian pilgrims and NRIs. Compare routes, permits, cost, best time, packing list, altitude safety and booking support from Nepal."
        keywords="Kailash Mansarovar Yatra guide, Kailash Mansarovar Yatra from India, Kailash Yatra for NRI, Kailash Yatra cost, Kailash Mansarovar permit, best time Kailash Yatra, Mount Kailash pilgrimage guide"
        url={pageUrl}
        image="https://www.zeotourism.com/images/kailash-mansarovar-yatra.jpg"
        type="article"
        langUrls={{
          ...
          <div className="relative container mx-auto px-4 py-24 md:py-36 max-w-4xl">
            <motion.div initial="hidden" animate="visible" variants={fadeUp}>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link
                  to="/kailash-mansarovar-yatra-cost"
                  className="inline-flex items-center gap-2 border-2 border-white/40 hover:border-white text-white font-bold px-8 py-4 transition-colors"
                >
        ...
        <div className="container mx-auto px-4 max-w-4xl py-16 space-y-20">
          ...
          <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link to="/kailash-mansarovar-yatra-cost" className="border border-gray-200 p-6 hover:border-primary transition-colors">
              ...
              <Link to="/kailash-mansarovar-yatra-documents-permits" className="border border-gray-200 p-6 hover:border-primary transition-colors">
          ...
          <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="mt-4">
                <Link to="/contact" className="inline-flex items-center gap-2 bg-primary text-white font-bold px-6 py-3 hover:bg-primary-dark transition-colors">
          ...
          <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link to="/kailash-mansarovar" className="inline-flex items-center gap-2 bg-secondary hover:bg-secondary-dark text-white font-bold px-8 py-4 transition-colors">
                View All Yatra Packages <ArrowRight className="w-5 h-5" />
              </Link>
              <Link to="/contact" className="inline-flex items-center gap-2 border-2 border-white/40 hover:border-white text-white font-bold px-8 py-4 transition-colors">
