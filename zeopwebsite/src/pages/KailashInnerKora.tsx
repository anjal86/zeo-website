...
const KailashInnerKora: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Kailash Inner Kora Guide 2026 | Nandi Parvat & Astapad"
        description="Explore the sacred Inner Circle of Mount Kailash. Specialized guide for the Inner Kora, including permits, route maps, and spiritual significance of the South Face."
        keywords="Inner Kora Kailash, Nandi Parvat circuit, Astapad trek Tibet, Kailash Inner Circle, South Face Kailash pilgrimage"
        url={pageUrl}
        image="https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=2070"
        type="article"
