  ...
  return (
    <>
      <SEO
        ...
        keywords="Kailash Mansarovar Yatra cost 2026, Kailash Yatra cost from Nepal, Kailash Mansarovar cost from Kathmandu, Mount Kailash tour package cost"
        url={pageUrl}
        image="https://www.zeotourism.com/images/kailash-mansarovar-yatra.jpg"
        type="article"
          ...
          <div className="section-container max-w-5xl">
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <aside className="border border-gray-200 p-6">
                ...
                <Link to="/contact" className="inline-flex items-center gap-2 bg-primary text-white px-5 py-3 font-bold hover:bg-primary-dark">
        ...
        <section className="py-14 bg-slate-950 text-white">
          <div className="section-container max-w-5xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/kailash-mansarovar" className="bg-white text-gray-900 px-6 py-3 font-bold">View Kailash packages</Link>
              <Link to="/kailash-mansarovar-yatra-documents-permits" className="border border-white/40 px-6 py-3 font-bold">Documents and permits guide</Link>
            </div>
          </div>
        </section>
      </div>
