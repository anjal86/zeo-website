...
const BestTimeToVisitNepal: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Best Time to Visit Nepal 2026 | Monthly Weather & Guide"
        description="When should you visit Nepal? Our 2026 guide covers peak trekking months, monsoon survival, and the best time for cultural festivals in Kathmandu."
        keywords="best time for Nepal, Nepal weather October, Everest trek season, Nepal monsoon months, spring in Nepal"
        url={pageUrl}
        image="https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=2070"
        type="article"
