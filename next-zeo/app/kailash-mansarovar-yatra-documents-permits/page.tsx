        ...
        <section className="py-14 bg-slate-950 text-white">
          <div className="section-container max-w-5xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/contact" className="bg-white text-gray-900 px-6 py-3 font-bold inline-flex items-center gap-2">Check documents <Phone className="w-4 h-4" /></Link>
              <Link href="/kailash-mansarovar-yatra-cost" className="border border-white/40 px-6 py-3 font-bold">Read cost guide</Link>
            </div>
          </div>
        </section>
      </div>
