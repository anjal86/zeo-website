      ...
      <div className="bg-white">
        ...
        <div className="container mx-auto px-4 max-w-4xl py-16 space-y-20">
          ...
          <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-slate-900 text-white p-8 md:p-12">
            ...
            <p className="text-white/60 mb-8">Having the right gear is only half the battle. Read our <Link href="/kailash-fitness-medical-guide" className="text-secondary font-bold hover:underline">Fitness & Medical Safety Guide</Link> for detailed AMS prevention tips.</p>
