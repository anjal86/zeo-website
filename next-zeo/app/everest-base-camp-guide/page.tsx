          ...
          <div className="relative container mx-auto px-4 py-24 md:py-36 max-w-4xl text-center">
            <motion.div initial="hidden" animate="visible" variants={fadeUp}>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link href="/tours/everest-base-camp-trek-13n-14d" className="inline-flex items-center gap-2 bg-secondary hover:bg-secondary-dark text-white font-bold px-8 py-4 transition-colors">
        ...
        <div className="container mx-auto px-4 max-w-4xl py-16 space-y-20">
          ...
          <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link href="/destinations/nepal" className="inline-flex items-center gap-2 border-2 border-white/40 hover:border-white text-white font-bold px-8 py-4 transition-colors">
                Explore Nepal Tours
              </Link>
            </div>
          </motion.section>
