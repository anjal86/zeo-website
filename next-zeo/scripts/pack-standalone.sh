...
mkdir -p "$STAGING_DIR/deployment/webhook"
cp deployment/webhook/deploy.php "$STAGING_DIR/deployment/webhook/deploy.php"
cp deployment/webhook/deploy-config.php.example "$STAGING_DIR/deployment/webhook/deploy-config.php.example"
